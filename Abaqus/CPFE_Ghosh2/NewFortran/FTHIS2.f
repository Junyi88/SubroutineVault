...
c Initialisation
      ...
      DO i=1, 9
         ...
         write(6,*) 'KCURLFP_OUTA' , noel, npt, i, 770+I
         write(6,*) kcurlFp(noel,npt,i), STATEV(770+I), kDGA(noel,npt,i)
         
         STATEV(750+I) = kFp(noel,npt,i)
         STATEV(720+I) = kX(noel,npt,i)         
      END DO	  
...
C          END DO	  
      ...
      DO J =1, 8
          DO i=1, 9
              ...
              kDGA(noel,J,i) = J*10+I

              STATEV(600+(10*J)+I) = svars(9+i + 18*(J-1))
              STATEV(500+(10*J)+I) = svars(i + 18*(J-1))
              
         write(6,*) 'KCURLFP_IN' , noel, npt, i, J 
         write(6,*) kcurlFp(noel,J,i),svars(9+i + 18*(J-1)),
     1            STATEV(600+(10*J)+I), (9+i + 18*(J-1))
          END DO
      END DO
