...
Pr3(13)= c10.*kB.*Temp./(G.*(b.^3));

Pr3(14)=c3.*G.*b;
Pr3(15)=c4.*kB.*Temp./(b.^2);

Pr3(16)=b./Ga111;
Pr3(17)=G.*(b.^3)./(4.*pi);
Pr3(18)=G.*(b.^2)./(2.*pi.*Ga111);
Pr3(19)=xi0.*exp(A./(Temp-thetaC));
Pr3(20)=TauCC;
Pr3(21)=G.*b.*b.*b./(4.*pi);
Pr3(22)=h;
Pr3(23)=k1;
Pr3(24)=k2;
Pr3(25)=(1./sqrt(3))-Ga010./Ga111;
B=G.*b.*b./(2.*pi.*Ga111);
Pr3(26)=b./B; 
Pr3(27)=rho0;
Pr3(28)=kB.*Temp;

Pr3(29)=(c10.*kB.*Temp./(G.*(b.^2)));
Pr3(29)=Pr3(29)*c1.*(Temp.^c2)*exp(-Q./(kB.*Temp)); 
Pr3(30)=P;


Pr3(31)=c5./b; 
Poisson=C12./(2.*(C12+C44));
Pr3(32)=c6.*(sqrt(3).*G)./(16.*(1-Poisson));
Pr3(33)=c7; Pr3(33)=0;
Pr3(34)=0.0; 
Pr3(35)=c9; Pr3(35)=0;
Pr3(36)=1.0;
