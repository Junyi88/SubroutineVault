...
c
     ...
     3 props(nprops),coords(3),drot(3,3),dfgrd0(3,3),dfgrd1(3,3)
      ...
      INTEGER:: ISLIPS, I, J, NDUM1, NA, NB, kint
      ...
      real*8:: svars(144)
      real*8:: xnat(20,3),xnat8(8,3),gauss(8,3)
...
C     
      ...
      integer, parameter :: TOTALELEMENTNUM=1000, nsvars=144, knsdv=18
...
c XDANGER
       DO ISLIPS=1,18
		...
		STATEV(465+ISLIPS)=1.0e9
        STATEV(483+ISLIPS)=1.0e9
        STATEV(501+ISLIPS)=1.0e9   
       END DO	 
c      DO ISLIPS=1,6
