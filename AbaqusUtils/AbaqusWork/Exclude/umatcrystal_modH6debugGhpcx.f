...
c
     ...
     5          DHDGDG(ND,ND)
      ...
      REAL*8 JUNYIFLAG,JUNYIDTMIN
      CHARACTER(len=255) :: cwd	  , JUNYITEXT1, JUNYITEXT2,JUNYITEXT3
      INTEGER:: STRINGLEN
      JUNYIDTMIN=1.0D-14	  
...
c      inquire(unit=6,NAME=JUNYITEXT1)
c      STRINGLEN=LEN(TRIM(JUNYITEXT1))
c      JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"
c	  write(6,*) "****************************"
c	  write(6,*) "JUNYIX=", JUNYITEXT2
c	  write(6,*) "JUNYIY=", JUNYITEXT1
	  
c      Open(UNIT=142,FILE=JUNYITEXT2,STATUS="REPLACE")
c      write(6,*) "KINC=", KINC
c      write(142,*) "****************************"

c      write(142,*) "KINC=", KINC
c      write(6,*) "write="
c      Close(142)
c      write(6,*) "close="
CJ Debug F==========================================================
...
CJ Debug S==========================================================
c      write(6,*) "L:512"
c      inquire(unit=6,NAME=JUNYITEXT3)
c      write(6,*) "JUNYI6=", JUNYITEXT3
c      inquire(unit=142,NAME=JUNYITEXT3)
c      write(6,*) "JUNYI142=", JUNYITEXT3
CJ Debug F==========================================================
...
c            STRINGLEN=LEN(TRIM(JUNYITEXT1))
c            JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"
c            write(6,*) "JUNYITEXT_747=", JUNYITEXT2
c            Open(UNIT=142,FILE=JUNYITEXT2,STATUS="OLD", ACCESS="APPEND")
c            write(6,*) "JUNYITEXT_747P=", JUNYITEXT2
c            write(142,*) "/////////////////////////////////////////////"
c            write(142,*) "NITRTN=", NITRTN
c            Close(142)
CJ Debug F==========================================================
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_794=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_825=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_835=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_870=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ LINEARISE
c      IF (JUNYIFLAG.EQ.1) THEN
	  
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_X2=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_988=", JUNYITEXT2
CJ Debug F==========================================================		 
...
C
     ...
     2                    PROPS(65+8*I),PROPS(155+I),PROPS(157+I),
     2                    PROPS(159+I))
      END DO
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_1010=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_1045=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_1080=", JUNYITEXT2
CJ Debug F==========================================================		 
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_1090=", JUNYITEXT2
c            inquire(unit=6,NAME=JUNYITEXT1)
c            STRINGLEN=LEN(TRIM(JUNYITEXT1))
c            JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"			
c            Open(UNIT=142,FILE=JUNYITEXT2,STATUS="OLD", ACCESS="APPEND")
c            write(142,*) "DGamma_1032=", DGAMMA
c            write(142,*) "-----------------------------------------"
c            close(142)
CJ Debug F==========================================================	  
...
c      IF (DSTRES(I).GT.1.0d2) THEN
c         WRITE (6,*) 'ERROR: Large Stress Increments'
c         WRITE (6,*) 'X=',X,kspt,kstep,kinc
c         WRITE (6,*) 'F=', F(X,PROPS(65+8*I),PROPS(155+I),PROPS(157+I))
c         WRITE (6,*) 'DFDX=', DFDX(X,PROPS(65+8*I),PROPS(155+I),PROPS(157+I))
c      ENDIF
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_1221=", JUNYITEXT2
c            inquire(unit=6,NAME=JUNYITEXT1)
c            STRINGLEN=LEN(TRIM(JUNYITEXT1))
c            JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"			
c            Open(UNIT=142,FILE=JUNYITEXT2,STATUS="OLD", ACCESS="APPEND")
c            write(142,*) "Line No: 1198"
c            write(142,*) "I=", I
c            write(142,*) "STRESS(I)", STRESS(I)	
c            write(142,*) "-----------------------------------------"
c			close(142)
CJ Debug F==========================================================			 
      END DO
...
CJ REQUEST SMALLER TIME STEP
               IF (X.GT.1.0d2) THEN
                    WRITE (6,*) '================================================'
                    WRITE (6,*) 'X=',X,kspt,kstep,kinc
                    WRITE (6,*) 'STATEV(2*NSLPTL+ID)=',STATEV(2*NSLPTL+ID)
                    WRITE (6,*) 'STATEV(ID)=',STATEV(ID)
                    WRITE (6,*) '(NSLPTL,ID)=',NSLPTL,ID
                    WRITE (6,*) 'NITRTN',NITRTN
                    PNEWDT=0.25
c                    X=15
               ...
               RESIDU=THETA*DTIME*F(X,PROPS(65+8*I),
     1		           PROPS(155+I),PROPS(157+I),PROPS(159+I))+
     1		           DTIME*(1.0-THETA)*
...
CJ Debug S==========================================================
c            write(6,*) "JUNYITEXT_2196=", JUNYITEXT2
c            inquire(unit=6,NAME=JUNYITEXT1)
c            STRINGLEN=LEN(TRIM(JUNYITEXT1))
c            JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"			
c            Open(UNIT=142,FILE=JUNYITEXT2,STATUS="OLD", ACCESS="APPEND")
CJ Debug F==========================================================	  
      DO I=1,NSLIP
         X=TAUSLP(I)/GSLIP(I)
         FSLIP(I)=F(X,PROP,Z,B3,B4)
         DFDXSP(I)=DFDX(X,PROP,Z,B3,B4)
...
c            JUNYITEXT2=TRIM(JUNYITEXT1(1:STRINGLEN-4))//".debugfile"			
c            Open(UNIT=142,FILE=JUNYITEXT2,STATUS="OLD", ACCESS="APPEND")
c            write(142,*) "Line No: 2166"
c            write(142,*) "I=", I
c            write(142,*) "X(I)=", X
c            write(142,*) "F(I)=", FSLIP(I)
c            write(142,*) "DFDXSP(I)=", DFDXSP(I)			
c            write(142,*) "-----------------------------------------"
c            close(142)
CJ Debug F==========================================================	 		 
...
C-----  Use single precision on cray
C
           REAL*8 FUNCTION F(X,PROP,Z,B3,B4)
...
CJ           F=PROP(2)*(ABS(X))**PROP(1)*DSIGN(1.D0,X)
...
CJ------------------------
           ...
           N=PROP(1)
            ...
            IF (ABS(X).LT.ABS(Z)) THEN
             F=PROP(2)*(ABS(X))**PROP(1)*DSIGN(1.D0,X)
            ELSE	
			
             B2=((A*N*(ABS(Z)**(N-1.0)))-B4)/(ABS(Z)**(-B3))	
             B1=(A*(ABS(Z)**N))-((B2/(1-B3))*(ABS(Z)**(1.0-B3)))
     2           -B4*ABS(Z)
	 
             F=(B1+(B2/(1.0-B3))*(ABS(X)**(1.0-B3))	 
     2          +B4*ABS(X))*DSIGN(1.D0,X)
c             WRITE (6,*) 'F,X=',F,X
...
C-----  Use single precision on cray
C
           REAL*8 FUNCTION DFDX(X,PROP,Z,B3,B4)
...
CJ           DFDX=PROP(1)*PROP(2)*(ABS(X))**(PROP(1)-1.)
